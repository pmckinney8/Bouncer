...
(function(global, $){
  ...
  var init = function(validation_array){
    return new Bouncer(validation_array);
  }

  function Bouncer(validation_array){
  ...
  Bouncer.prototype = {
    validate : function(){
      console.log("validate called",this.validation_array.length);
  ...
  Bouncer.prototype = Bouncer.prototype

  global.StartBouncer = init;
